...
audio_file = "https://www.soundboard.com/handler/DownLoadTrack.ashx?cliptoken=55227092-2391-4e45-8b17-062e49c7161b"
st.audio(audio_file)
...
with col1:
    if st.button('YES! 😍'):
        ...
        st.write("Ab jaldi se WhatsApp par 'YES' likh kar bhejo! 📱")
